...
static float computeFirstOrder(float currentInput, struct firstOrderData *filterParameters)
{
...
static void setupFilters(float oneG)
{
/*  
...
static void matrixMultiply(int aRows, int aCols_bRows, int bCols, float matrixC[], float matrixA[], float matrixB[])
{
  //int i, j, k;
...
static void matrixSubtract(int rows, int cols, float matrixC[], float matrixA[], float matrixB[])
{
  //int i;
...
static void matrixScale(int rows, int cols, float matrixC[], float scaler, float matrixA[])
{
  //int i;
...
static void matrixTranspose3x3(float matrixC[9], float matrixA[9])
{
...
static void matrixInverse3x3(float matrixC[9], float matrixA[9])
{
...
static float findMedian(float *data, int arraySize) {
  float temp;
#else
static int findMedian(int *data, int arraySize) {                  //Thanks ala42! Post: http://aeroquad.com/showthread.php?1369-The-big-enhancement-addition-to-2.0-code/page5
  int temp;
#endif
  boolean done = 0;
  //byte i;
